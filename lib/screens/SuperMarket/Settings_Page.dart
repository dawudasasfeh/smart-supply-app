...
class SupermarketSettingsPage extends StatefulWidget {
  const SupermarketSettingsPage({Key? key}) : super(key: key);

  @override
  State<SupermarketSettingsPage> createState() => _SupermarketSettingsPageState();
}

class _SupermarketSettingsPageState extends State<SupermarketSettingsPage> {
